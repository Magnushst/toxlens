...
python shap_and_saliency_vis.py --class_ckpt "C:/Users/magnu/Desktop/models/.../best.ckpt" --tasks Ames,SR-MMP --num_molecules 3 --random_repeats 30 --device cuda

For a cleaner side-by-side saliency figure where only the strongest atoms are coloured:

python shap_and_saliency_vis.py --class_ckpt "C:/Users/magnu/Desktop/models/.../best.ckpt" --tasks Ames,SR-MMP --num_molecules 3 --top_fraction 0.20
"""
...
def resolve_latest_classification_checkpoint() -> Path:
    ...
    model_root = Path(os.environ.get("DEEP_TOX_CHECKPOINT_DIR", r"C:\Users\magnu\Desktop\models"))
    patterns = [
